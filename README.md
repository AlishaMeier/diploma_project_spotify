...
Spotify Automation Testing Project - дипломный проект, направленный на демонстрацию навыков автоматизации тестирования API и UI реального веб-приложения.
...
| 🔍 Тест                                                                    | 💡 Статус |
|----------------------------------------------------------------------------|:---------:|
| Успешная авторизация пользователя                                          |   50/50   |
...
| Запрос плейлиста по невалидному ID                 | ✅ |
...
| Создание плейлиста без имени                 | ✅ |
| Добавление трека с невалидным URI                 | ✅ |
| Добавление, проверка и удаление альбома из медиатеки                | ✅ |
| Сохранение несуществующего альбома                 | ✅ |
| Подписка и отписка от артиста                 | ✅ |
| Подписка на несуществующего артиста                 | ✅ |
